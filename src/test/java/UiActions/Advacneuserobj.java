...
public class Advacneuserobj extends TestBase
{
	WebDriver driver;
	SoftAssert softassert=new SoftAssert();
	Actions a = new Actions(driver);
    public static final Logger log=Logger.getLogger(Advacneuserobj.class.getName());
    ...
    public void advuseroperations(String username, String password) throws Exception
    {
  	  //enter user name 
  	  Thread.sleep(5000);
